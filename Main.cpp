...
int main()
{
	...
	// In this case we are using OpenGL 3.3.4
	...
	// Create a GLFWwindow object of 800 by 800 pixels, naming it "TryOpenGL"
	GLFWwindow* window = glfwCreateWindow(800, 800, "TryOpenGL", NULL, NULL);
